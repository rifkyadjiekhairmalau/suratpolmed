...
export default function Login({ status, canResetPassword }) {
    ...
    <GuestLayout>
        ...
        <form onSubmit={submit} className="bg-white/80 rounded-xl shadow-lg p-6">
            <div>
            ...
            <div className="mt-4 flex flex-col gap-4 items-end">
                ...
                <PrimaryButton className="bg-violet-600 hover:bg-violet-700 transition text-white font-semibold" disabled={processing}>
                    Log in
                </PrimaryButton>
            </div>
        </form>

        {/* Tambahkan tombol Register di luar form */}
